...
| secrets | object | `{}` | Additional secrets passed through environment variables to containers. See the [API reference](https://kubernetes.io/docs/reference/kubernetes-api/workload-resources/pod-v1/#environment-variables) for details. |
